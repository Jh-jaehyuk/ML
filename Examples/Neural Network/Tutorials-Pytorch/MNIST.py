...
# MNIST 데이터 불러오기
mnist_train = datasets.FashionMNIST(root="../Tutorials-Pytorch", train=True, transform=transforms.ToTensor(), target_transform=None, download=True)
mnist_test = datasets.FashionMNIST(root="../Tutorials-Pytorch", train=False, transform=transforms.ToTensor(), target_transform=None, download=True)
